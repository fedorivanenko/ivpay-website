...
type ISO3166_1_alpha_2_TwoLetterCountryCodes = 
...
type FlagMarquee = StepMarqueeWrapperProps & {
    countries: ISO3166_1_alpha_2_TwoLetterCountryCodes[]
}
    ...
    return (
        ...
        >
            {countries.map((country, index) => (
                <CircleFlag key={index} countryCode={country} className="h-full aspect-square" />
            ))
            }
        </StepMarqueeWrapper>
    )
