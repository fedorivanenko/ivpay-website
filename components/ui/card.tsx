...
const Card = React.forwardRef<HTMLDivElement, DivProps>(
  ({ className, children, ...props }, ref) => (
    <m.div
      ...
      className={cn(
        "rounded-xl border backdrop-blur box-border border-background/50 sm:rounded-2xl bg-background/60 text-card-foreground overflow-hidden relative z-0 shadow-card-shadow",
        className
      )}
